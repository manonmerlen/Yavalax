...
class Gui extends OpenXum.Gui {
    ...
    _draw_state() {
        ...
        if (this.engine()._winner) {
           // this.engine()._winning_piece(this.selected_cord[0], this.selected_cord[1], this.engine().current_color());
            this._crown_place(this.engine().last_column, this.engine().last_line, this.engine().color_winner);
        }
