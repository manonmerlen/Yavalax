...
class Engine extends OpenXum.Engine {
  constructor(t, c) {
    ...
    this._previous_previous_player = Color.NONE;
  ...
  clone() {
    ...
    o._previous_previous_player = this._previous_previous_player;
    return o;
  }
  ...
  move(move) {
    ...
    this._previous_previous_player = this._previous_player;
  ...
  undo_move(move) {
    ...
    this._previous_player = this._previous_previous_player;
  }
